...
const CreateCurrentTask = () => {
  const navigation = useNavigation();

  return (
    <View style={styles.createCurrentTask}>
      ...
      <View style={styles.createCurrentTaskChild} />
      ...
      <Image
        style={[styles.createCurrentTaskItem, styles.createLayout]}
        contentFit="cover"
        source={require("../assets/vector-13.png")}
      />
      <Image
        style={[styles.createCurrentTaskInner, styles.createLayout]}
        contentFit="cover"
        source={require("../assets/vector-13.png")}
      />
      <Image
      ...
      <Image
        style={[styles.createCurrentTaskChild1, styles.createLayout]}
        contentFit="cover"
        source={require("../assets/vector-13.png")}
      />
...
const styles = StyleSheet.create({
  ...
  createCurrentTaskItem: {
    top: 187,
  },
  createCurrentTaskInner: {
    top: 413,
  },
  vectorIcon: {
    top: 586,
...
export default CreateCurrentTask;
