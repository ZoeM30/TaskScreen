...
const ViewCurrentTaskDetail = () => {
  const navigation = useNavigation();

  return (
    <View style={styles.viewCurrentTaskDetail}>
      <Image
      ...
      <View style={[styles.viewCurrentTaskDetailChild, styles.viewPosition]} />
      <View style={[styles.viewCurrentTaskDetailItem, styles.viewPosition]} />
      ...
      <View
        style={[
          styles.viewCurrentTaskDetailInner,
          styles.todaysRemindersWrapperLayout,
        ]}
      >
        <View
          style={[
        ...
        <View style={[styles.group3, styles.groupPosition]}>
          <View style={[styles.group1, styles.groupPosition1]}>
            <View style={[styles.group5, styles.groupPosition1]}>
              <Text style={[styles.designChanges1, styles.homeTypo1]}>
                Assignment 4
              </Text>
            </View>
      ...
      />
      <Image
        style={[styles.viewCurrentTaskDetailChild1, styles.ellipseIconLayout]}
        contentFit="cover"
      ...
      <Image
        ...
        contentFit="cover"
        source={require("../assets/rectangle-4281.png")}
      />
      <Text style={styles.text1}>House Cleaning</Text>
      <Text style={styles.oct242022}>Oct 24, 2022</Text>
      ...
      <Text
        style={[styles.currentBalance, styles.homeTypo]}
      >{`lower stress levels are one of the many benefits of a clean home. 

Making sure your entire home is clean can have a huge impact on your physical health.`}</Text>
...
const styles = StyleSheet.create({
  ...
  viewCurrentTaskDetailChild: {
    top: 168,
  },
  viewCurrentTaskDetailItem: {
    top: 547,
  },
  cardShadowBox: {
    shadowOpacity: 1,
...
export default ViewCurrentTaskDetail;
