...
const EditTaskDescription = () => {
  ...
  return (
    <View style={styles.editTaskDescription}>
      ...
      />
      <View style={styles.editTaskDescriptionChild} />
      <Text style={[styles.name, styles.nameTypo]}>Name</Text>
      <Text style={[styles.description, styles.categoryTypo]}>Description</Text>
      <Text style={[styles.category, styles.categoryTypo]}>Category</Text>
      <Image
        style={[styles.editTaskDescriptionItem, styles.vectorIconLayout]}
        contentFit="cover"
      ...
      <View style={styles.editTaskDescriptionInner}>
